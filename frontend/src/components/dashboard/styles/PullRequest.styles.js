...
import { fadeInUp } from "./Dashboard.styles";

// everything below adds style to a single repo's pull request page
...
// the status word itself gets colored by what it says — open/closed/reviewed each get their own
